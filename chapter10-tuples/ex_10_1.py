...
for line in file:
    if line.startswith('From '):
        line = line.split()
        line = line[1]
        senderd[line] =  senderd.get(line,0) + 1
reversedlist = list()
for k,v in senderd.items():
    reversedlist.append((v,k))
reversedtuple = sorted(reversedlist,reverse=True)[0]
print(reversedtuple[1],reversedtuple[0])
